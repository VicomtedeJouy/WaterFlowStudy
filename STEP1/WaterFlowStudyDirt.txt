...
def main(startPoint, facadeMesh, windVect, stepSize, maxSteps):
    ...
    for pt in startPoint:
        ...
        tempWaterPath, pts, lDirt = pathDrawing(drop)
...
### DRAWING PARAMETERS AND DATA COLLECTORS ###
...
fCrvs, impactPoints, rainLines = main(startPoint, facadeMesh, windVect, stepSize, maxSteps)
